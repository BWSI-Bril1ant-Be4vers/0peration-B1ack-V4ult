...
export const STORAGE_KEY = "blackvault-save-v1";
...
export const RANKS = [
  { min: 0, name: "ROOKIE" },
  { min: 2500, name: "ANALYST" },
  { min: 4500, name: "CYBER OPERATIVE" },
  { min: 6500, name: "ELITE OPERATOR" },
  { min: 8200, name: "BLACK VAULT LEGEND" },
];
