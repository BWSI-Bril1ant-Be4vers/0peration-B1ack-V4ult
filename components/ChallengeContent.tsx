...
key:         the name of the system hunting you`}</Mono>
    ...
    case 14:
      return (
        <div className="space-y-3">
          {/* To show the actual surveillance photo, drop an image at public/room14.jpg
              and replace this panel with: <img src="/room14.jpg" alt="Surveillance capture" className="rounded-lg border border-slate-800" /> */}
          <Panel label="surveillance capture — geolocated">
            <div className="space-y-3 text-sm">
              <div className="font-mono text-cyan-300 text-xs tracking-widest">
                LOCATION LOCKED: CRAWLEY AVENUE · CRAWLEY · UNITED KINGDOM
              </div>
              ...
              <p className="text-xs text-amber-300/80 font-mono">
                NOTE: This objective requires real-world map research. Use your external OSINT toolkit.
              </p>
            </div>
          </Panel>
        </div>
