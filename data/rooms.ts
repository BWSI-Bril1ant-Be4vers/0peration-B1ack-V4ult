...
export const ROOMS: Room[] = [
  ...
  },
  {
    ...
    difficulty: "Medium",
    story:
      "A courier for the bank was photographed making a hand-off somewhere in southern England — location unknown. Intelligence says the courier had ID photos taken at the nearest photo booth minutes earlier. Geolocate the capture, then find the booth. This room requires real-world research — open your OSINT toolkit.",
    question: "What is the name of the nearest ID photo booth / photo service to the capture location?",
    hint: "Reverse image search the capture (Google Lens handles street scenes well). Once you have the location, check what photo services operate inside the supermarket next door.",
